...
function topological_sort (frandre, from_node, from_port) {
    const marks = {};
    const list = [];
...
function can_reach (frandre, from_id, from_port, to_id, to_port) {
    const marks = {};
...
function propagate (frandre, from_id, from_port, event_value) {
